...
namespace Common.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// </returns>
        public static string Base64Encode(this byte[] originalStream)
        {
        ...
        /// </returns>
        public static byte[] Base64Decode(this string encodedTextValue)
        {
        ...
        /// </returns>
        public static async Task<string> CompressGZipAsync(this string originalTextValue, CancellationToken cancellationToken)
        {
        ...
        /// </returns>
        public static async Task<string> DecompressGZipAsync(this string compressedTextValue, CancellationToken cancellationToken)
        {
        ...
        /// </returns>
        public static TData ChangeType<TData>(this string originalTextValue)
        {
            if (originalTextValue.IsNullOrEmpty() &&
        ...
        /// </returns>
        public static string Join(this IEnumerable<string> collection, string suffix = "")
        {
