...
namespace EventsHandler.Mapping.Models.POCOs.OpenZaak.Decision
{
    ...
    public struct DecisionResource : IJsonSerializable
    {
        ...
        [JsonPropertyOrder(0)]
        public Uri InfoObjectUri { get; internal set; } = CommonValues.Default.Models.EmptyUri;
        ...
        [JsonPropertyOrder(1)]
        public Uri DecisionUri { get; internal set; } = CommonValues.Default.Models.EmptyUri;
