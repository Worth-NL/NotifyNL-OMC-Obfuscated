...
namespace EventsHandler.Behaviors.Mapping.Helpers
{
    /// <summary>
    ...
    internal sealed class PropertiesMetadata : IReadOnlyList<PropertyInfo>
    {
        ...
        internal PropertiesMetadata(object instance, params string[] exclusions)
        {
            // Preparation
        ...
        /// <summary>
        /// Gets the JSON-associated (Dutch) name of the property from the internal bilingual dictionary of names.
        /// </summary>
        internal string GetPropertyDutchName(PropertyInfo property)
            => this.English_To_Dutch[RetrievePropertyEnglishName(property)].DutchName;

        /// <summary>
        /// Gets the plain C# (English) name of the property from the internal bilingual dictionary of names.
        /// </summary>
        internal string GetPropertyEnglishName(string dutchName)
        ...
        /// </summary>
        internal bool TryGetPropertyDutchName(string englishName, out (int Index, string DutchName) record)
        ...
        /// </summary>
        internal bool TryGetPropertyEnglishName(string dutchName, out (int Index, string EnglishName) record)
        ...
        /// </summary>
        internal bool TryGetPropertyValueByEnglishName<TInstance>(string englishName, TInstance instance, [MaybeNullWhen(false)] out object value)
        {
        ...
        /// <summary>
        /// Custom delegate to be used by internal logic.
        /// </summary>
