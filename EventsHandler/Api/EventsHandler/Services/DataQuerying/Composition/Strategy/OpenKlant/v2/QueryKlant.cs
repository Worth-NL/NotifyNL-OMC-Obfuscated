...
namespace EventsHandler.Services.DataQuerying.Composition.Strategy.OpenKlant.v2
{
    ...
    internal sealed class QueryKlant : IQueryKlant
    {
        ...
        async Task<CommonPartyData> IQueryKlant.TryGetPartyDataAsync(IQueryBase queryBase, string bsnNumber)
        {
            ...
            string partiesEndpoint = $"https://{((IQueryKlant)this).Configuration.ZGW.Domain.OpenKlant()}/partijen";
        ...
        {
            // Predefined URL components
            Uri klantContactMomentUri = new($"https://{((IQueryKlant)this).Configuration.ZGW.Domain.OpenKlant()}/klantcontacten");
        ...
        {
            // Predefined URL components
            Uri objectContactMomentUri = new($"https://{((IQueryKlant)this).Configuration.ZGW.Domain.OpenKlant()}/onderwerpobjecten");
        ...
        {
            // Predefined URL components
            Uri customerContactMomentUri = new($"https://{((IQueryKlant)this).Configuration.ZGW.Domain.OpenKlant()}/betrokkenen");
