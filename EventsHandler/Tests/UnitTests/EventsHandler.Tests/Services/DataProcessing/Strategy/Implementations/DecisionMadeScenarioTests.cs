...
namespace EventsHandler.UnitTests.Services.DataProcessing.Strategy.Implementations
{
    ...
    public sealed class DecisionMadeScenarioTests
    {
        ...
        {
            this._testConfiguration = ConfigurationHandler.GetWebApiConfigurationWith(ConfigurationHandler.TestLoaderTypes.BothValid);
        }
        ...
        private static readonly Uri s_validUri =
            new($"https://www.domain.com/{ConfigurationHandler.TestMessageObjectTypeUuid}");  // NOTE: Matches to UUID from test Environment Configuration
