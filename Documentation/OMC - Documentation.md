  ...
  "profiles": {
    ...
    "IIS Express (Development)": {  // NOTE: Name of the profile can be changed
      ...
      "environmentVariables": {
        ...
        "USER_TEMPLATEIDS_EMAIL_MESSAGE": "",
...
| USER_WHITELIST_ZAAKUPDATE_IDS                       | string[]  | "1, 2, 3, 4"                           | false        |                                                                                                                                            | Is provided by the user based on "Identificatie" property of case type retrieved from case URI ("zaak") from "OpenZaak" Web API service                                                                               |
| USER_WHITELIST_ZAAKCLOSE_IDS                        | string[]  | "1, 2, 3, 4"                           | false        |                                                                                                                                            | Is provided by the user based on "Identificatie" property of case type retrieved from case URI ("zaak") from "OpenZaak" Web API service                                                                               |
